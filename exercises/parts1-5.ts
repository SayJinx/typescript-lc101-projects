...
console.log(`${spacecraftName} takes ${getDaysToLocation(kilometersToTheMoon)} days to get to Mars.`)*/
...
class Spacecraft {
    ...
    function printDaysToLocation(location: SpaceLocation) {
...
let spaceShuttle = new Spacecraft("Ptolomaios", 200000);
